...
const About = () => {
  ...
  const faqs = [
    {
      question: "How accurate is the Health Sphere?",
      answer: "Our Health Sphere system has been trained on millions of medical records and cases, achieving an accuracy rate of over 90% for common conditions. However, it's designed to be a supplementary tool and not a replacement for professional medical advice."
    },
    {
    ...
    {
      question: "Can I use Health Sphere for emergencies?",
      answer: "No, Health Sphere is not suitable for emergency situations. If you're experiencing a medical emergency, please call emergency services immediately or visit the nearest emergency room."
    },
    {
      question: "How does the Health Sphere make diagnoses?",
      answer: "The Health Sphere analyzes your reported symptoms, medical history, and relevant factors using advanced machine learning algorithms. It compares this information against a vast database of medical knowledge to suggest possible conditions and treatments."
    },
    {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-medical-light py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-6">About Health Sphere</h1>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Our Health Sphere is trained to recognize and provide guidance on a wide range of common health conditions,
